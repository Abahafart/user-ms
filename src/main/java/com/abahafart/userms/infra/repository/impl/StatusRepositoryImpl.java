...
public class StatusRepositoryImpl implements StatusRepository {
  ...
  public StatusDO getByDescriptionAndType(String description, String type) {
    StatusEntity entity = jpaRepository.findByDescriptionAndType(description, type)
        .orElseThrow(() -> new ResourceNotFoundException(
            List.of(new Error(String.format(STATUS_NOT_FOUND, description, type), RESOURCE_NOT_FOUND_CODE))));
